...
export default function RippleButton({
  ...
  return (
    <button
      ref={buttonRef}
      className="font-jost duration-[600ms] relative flex items-center justify-center overflow-hidden rounded-2xl bg-zinc-900 p-[1.3rem] text-[1.2rem] font-medium text-white transition hover:text-white cursor-pointer"
      onMouseEnter={(e) => {
